        ...
        <div class = "container">
            <div class="row" style="padding:100px 0px 0px 0px;">
                <div class="card col-sm-4 game" style="width:100%;">
                    <img class="card-img-top" src="images/letdraw.png" alt="Card image" style="width:200px height: 120px;">
                    <div class="card-body">
                        <h4 class="card-title">Quick DRAW!</h4>
                        <p class="card-text">Some example text some example text. John Doe is an architect and engineer</p>
                        <a href="draw.php" class="btn btn-primary stretched-link" style="margin: auto">Play</a>
                    </div>
                </div>
                <div class="card col-sm-4 game" style="width:100%">
                    <img class="card-img-top" src="images/fruitcut.jpg" alt="Card image" style="width:200px height: 120px;">
                    <div class="card-body">
                        <h4 class="card-title">Fruit Cut</h4>
                        <p class="card-text">Some example text some example text. John Doe is an architect and engineer</p>
                        <a href="posenet.php" class="btn btn-primary stretched-link" style="margin: auto">Play</a>
                    </div>
                </div>
                <div class="card col-sm-4 game" style="width:100%">
                    <img class="card-img-top" src="images/runner.png" alt="Card image" style="width:200px height: 120px;">
                    <div class="card-body">
                        <h4 class="card-title">Roary the Runner</h4>
                        <p class="card-text">Some example text some example text. John Doe is an architect and engineer</p>
                        <a href="runner/index.html" class="btn btn-primary stretched-link" style="margin: auto">Play</a>
                    </div>
                </div>
            </div>
        </div>
